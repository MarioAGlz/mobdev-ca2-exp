...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["episode-details-episode-details-module"], {
  ...
  function srcAppPagesEpisodeDetailsEpisodeDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EpisodeDetailsPage = /*#__PURE__*/function () {
      ...
      _createClass(EpisodeDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.likeService.isLikedEp(this.episodeId).then(function (isFav) {
            _this.isLikedE = isFav;
          });
        }
      }, {
        key: "likedEpisode",
        value: function likedEpisode() {
          var _this2 = this;

          this.likeService.likedEpisode(this.episodeId).then(function () {
            _this2.isLikedE = true;
          });
        }
      }, {
        key: "dislikedEpisode",
        value: function dislikedEpisode() {
          var _this3 = this;

          this.likeService.dislikedEpisode(this.episodeId).then(function () {
            _this3.isLikedE = false;
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], src_app_services_like_service__WEBPACK_IMPORTED_MODULE_4__["LikeService"]])], EpisodeDetailsPage);
    /***/
  }
}]);
