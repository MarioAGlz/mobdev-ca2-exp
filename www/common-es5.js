...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getCharacters() {
          ...
          return this.http.get("https://www.breakingbadapi.com/api/characters?limit=21&offset=".concat(offset));
        }
        /* getCharacters() {
        ...
        */
        ...
        key: "getQuotes",
        value: function getQuotes(name) {
          return this.http.get("https://www.breakingbadapi.com/api/quote?author=".concat(encodeURI(name)));
        }
      }, {
        key: "getAllQuotes",
        value: function getAllQuotes() {
        ...
        key: "getDeaths",
        value: function getDeaths(name) {
          return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(encodeURI(name)));
        }
      }]);
  ...
  function srcAppServicesLikeServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY1 = 'likedEpisodes';
    var STORAGE_KEY2 = 'likedCharacters';
    ...
    var LikeService = /*#__PURE__*/function () {
      ...
      _createClass(LikeService, [{
        key: "getAllLikedEpisodes",
        value: function getAllLikedEpisodes() {
          return this.storage.get(STORAGE_KEY1);
        }
      }, {
        key: "isLikedEp",
        value: function isLikedEp(episodeId) {
          return this.getAllLikedEpisodes().then(function (result) {
            return result && result.indexOf(episodeId) !== -1;
          });
        }
      }, {
        key: "likedEpisode",
        value: function likedEpisode(episodeId) {
          var _this = this;

          return this.getAllLikedEpisodes().then(function (result) {
            if (result) {
              result.push(episodeId);
              return _this.storage.set(STORAGE_KEY1, result);
            } else {
              return _this.storage.set(STORAGE_KEY1, [episodeId]);
            }
          });
        }
      }, {
        key: "dislikedEpisode",
        value: function dislikedEpisode(episodeId) {
          var _this2 = this;
          ...
          return this.getAllLikedEpisodes().then(function (result) {
            if (result) {
              ...
              return _this2.storage.set(STORAGE_KEY1, result);
            }
          });
        }
      }, {
        key: "getAllLikedCharacters",
        value: function getAllLikedCharacters() {
          return this.storage.get(STORAGE_KEY2);
        }
      }, {
        key: "isLikedCh",
        value: function isLikedCh(charactId) {
          return this.getAllLikedCharacters().then(function (result) {
            return result && result.indexOf(charactId) !== -1;
          });
        }
      }, {
        key: "likedCharacter",
        value: function likedCharacter(charactId) {
          var _this3 = this;

          return this.getAllLikedCharacters().then(function (result) {
            if (result) {
              result.push(charactId);
              return _this3.storage.set(STORAGE_KEY2, result);
            } else {
              return _this3.storage.set(STORAGE_KEY2, [charactId]);
            }
          });
        }
      }, {
        key: "dislikedCharacter",
        value: function dislikedCharacter(charactId) {
          var _this4 = this;
