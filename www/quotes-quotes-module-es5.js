...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function srcAppPagesQuotesQuotesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuotesPage = /*#__PURE__*/function () {
      ...
      _createClass(QuotesPage, [{
        ...
        value: function openDetails(quote) {
          var qId = quote.quote_id;
          this.router.navigateByUrl("/tabs/quotes/".concat(qId));
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])], QuotesPage);
    /***/
  }
}]);
