...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quote-details-quote-details-module"], {
  ...
  function srcAppPagesQuoteDetailsQuoteDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuoteDetailsPage = /*#__PURE__*/function () {
      ...
      _createClass(QuoteDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.api.getQuote(this.qId).subscribe(function (res) {
            _this.quote = res[0];
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])], QuoteDetailsPage);
    /***/
  }
}]);
